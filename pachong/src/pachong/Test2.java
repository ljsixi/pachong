...
public class Test2 {
    //提取的数据存放到该目录下
    private static String savepath="E:/web crawler/";
    //等待爬取的url
    ...
    public static void main(String args[]){
        ...
        //网址为        http://book.dangdang.com/    https://www.bilibili.com/
//        String strurl="http://search.dangdang.com/?key=%BB%FA%D0%B5%B1%ED&act=input";
        String strurl="https://www.bilibili.com/";
        workurl(strurl,1);
    }
    ...
    public static void workurl(String strurl,int depth){
        ...
        System.out.print(strurl+"网页爬取完成，已爬取数量："+alloverurl.size());
        }
        //用递归的方法继续爬取其他链接
        if(allwaiturl.size()!=0){
        String nexturl=allwaiturl.get(0);
        allwaiturl.remove(0);
        System.out.println("剩余爬虫数量"+allwaiturl.size());
